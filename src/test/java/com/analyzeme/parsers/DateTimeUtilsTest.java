...
public class DateTimeUtilsTest {
    ...
    public void testParseTime() {
        Assert.assertEquals(LocalTime.of(10, 20, 30),
                DateAndTimeUtils.parseTime("10:20:30"));
    }
    ...
    public void testIsForValidDate() {
        Assert.assertTrue(
                DateAndTimeUtils.isValidDate("10-10-2010"));
    }

    @Test()
    public void testIsValidDateForValidFormatInvalidDate() {
        Assert.assertFalse(
                DateAndTimeUtils.isValidTime("30-2-2010"));
    }
    ...
    public void testParseDate() {
        Assert.assertEquals(LocalDate.of(2010, Month.OCTOBER, 10),
                DateAndTimeUtils.parseDate("10-10-2010"));
    }
    ...
    */
    ...
    public void testIsForValidDateTime() {
        Assert.assertTrue(
                DateAndTimeUtils.isValidDateTime("10-10-2010 10:10"));
    }

    @Test()
    public void testIsValidDateTimeForValidFormatInvalidDateTime() {
        Assert.assertFalse(
                DateAndTimeUtils.isValidTime("30-2-2010 40:40:12"));
    }

    @Test()
    public void testIsValidDatetimeForInvalidFormat() {
        Assert.assertFalse(
                DateAndTimeUtils.isValidTime("30.2-2010 12:03"));
    }

    @Test()
    public void testParseDateTime() {
        Assert.assertEquals(
                LocalDateTime.of(2010, Month.OCTOBER, 10, 10, 10),
