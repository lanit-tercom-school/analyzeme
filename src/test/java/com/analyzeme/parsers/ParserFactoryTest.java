...
public class ParserFactoryTest {
    ...
    public void testJsonParserCreation() {
        Assert.assertEquals(JsonParser.class,
                ParserFactory.createParser(
                        TypeOfFile.SIMPLE_JSON).getClass());
    }

    @Test
    public void testCsvParserCreation() {
        Assert.assertEquals(CsvParser.class,
                ParserFactory.createParser(
                        TypeOfFile.CSV).getClass());
    }

    @Test
    public void testExcelParserCreation() {
        Assert.assertEquals(ExcelParser.class,
                ParserFactory.createParser(
                        TypeOfFile.EXCEL).getClass());
    }
