...
public class UsersRepository {
    ...
    public static synchronized void checkInitialization()
        ...
        if (users == null) {
            throw new IllegalStateException(
                    "UsersRepository does not exist");
        }
    }
     ...
     * @throws Exception
     */
    public static synchronized String newItem(final String[] data)
            throws Exception {
        if(users == null) {
            throw new IllegalStateException(
                    "UsersRepository does not exist");
        ...
        if(data.length != 3) {
            throw new IllegalArgumentException(
                    "UsersRepository newItem(): wrong parameters");
        }
        for (String str : data) {
            if (str == null || str.equals("")) {
                throw new IllegalArgumentException(
                        "UsersRepository newItem(): empty argument");
            }
        }
        int id = users.size() + 1;
        UserInfo newUser = new UserInfo(data[0],
                id, data[1], data[2]);
        users.add(newUser);
     ...
     * @throws Exception
     */
    public static synchronized UserInfo findUser(final int id)
            throws Exception {
        if(users == null) {
            throw new IllegalStateException(
                    "UsersRepository does not exist");
        ...
        if (id <= 0 || id > users.size()) {
            throw new ArrayIndexOutOfBoundsException(
                    "UsersRepository findUser(int): incorrect userId");
        }
     ...
     * @throws Exception
     */
    public static synchronized UserInfo findUser(final String username)
            throws Exception {
        if(users == null) {
            throw new IllegalStateException(
                    "UsersRepository does not exist");
        ...
        if (username == null || username.equals("")) {
            throw new IllegalArgumentException(
                    "UsersRepository findUser(String): empty userId");
        }
        ...
        throw new IllegalArgumentException(
                "UsersRepository findUser(String): user does not exist");
    }
     ...
     * @throws Exception
     */
    public static synchronized String newProject(final String username,
        ...
        if (username == null || username.equals("") ||
            ...
            throw new IllegalArgumentException(
                    "UsersRepository newProject(String): incorrect username or projectName");
        }
     ...
     * @throws Exception
     */
    public static synchronized String newProject(final int userId,
                                                 final String projectName)
            throws Exception {
        if(users == null) {
            throw new IllegalStateException(
        ...
        if (userId <= 0 || projectName == null || projectName.equals("")) {
            throw new IllegalArgumentException(
                    "UsersRepository newProject(int): incorrect userId or projectName");
        }
     ...
     * @return
     */
    public static synchronized FileInfo findByReferenceName(
            final String referenceName, final String[] params)
            throws Exception {
        if(users == null) {
            throw new IllegalStateException("UsersRepository does not exist");
        }
        ...
        if (set == null) {
            throw new IllegalArgumentException(
                    "UsersRepository findByReferenceName(): impossible to find dataset");
        }
     ...
     * @return
     */
    public static synchronized DataSet getDataSetByReferenceName(
            final String referenceName, final String[] params)
            throws Exception {
        if(users == null) {
            throw new IllegalStateException("UsersRepository does not exist");
        ...
        if (referenceName == null || referenceName.equals("")) {
            throw new IllegalArgumentException(
                    "UsersRepository findByReferenceName(): empty referenceName");
        }
        if(params.length != 2) {
            throw new IllegalArgumentException(
                    "UsersRepository findByReferenceName(): wrong params");
        }
        for (String str : params) {
            if (str == null || str.equals("")) {
                throw new IllegalArgumentException(
                        "UsersRepository findByReferenceName(): empty projectId or userId");
            }
        }
        ...
        if (project == null) {
            throw new IllegalArgumentException(
                    "UsersRepository findByReferenceName(): project does not exist");
        }
