...
public class RenjinInputHandler {
    ...
    public static void insertData(final ScriptEngine engine, final List<DataSet> dataFiles)
            throws Exception {
    ...
    public static void insertData(final ScriptEngine engine, final Map<String, List<DataEntry>> data) throws Exception {
