...
public class ScalarFromR<T> implements IFromR<ScalarResult<T>> {
     ...
     */
    public <U> ScalarResult runScript(final String scriptName, final String rScript, final Map<String, List<U>> data) throws Exception {
