...
public class FileInRepositoryResolver implements IDataSetResolver {
    ...
    public void setProject(final int userId,
                           final String projectId) throws IllegalArgumentException {
    ...
    public DataSet getDataSet(final String referenceName) throws Exception {
        ...
        ProjectInfo project = UsersRepository
                .findUser(Integer.parseInt(params[0]))
                .getProjects().findProjectById(params[1]);
