 ...
 */
public class FileInRepositoryInfo implements ISourceInfo {
	private String uniqueNameInRepository;

	public FileInRepositoryInfo(final String uniqueNameInRepository) throws IllegalArgumentException {
