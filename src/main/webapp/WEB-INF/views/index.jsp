    ...
    <%--<nav class="navbar navbar-default navbar-fixed-top topnav" role="navigation">
        <div class="container">
            ...
            <div class="navbar-header pull-left">
                ...
                <a href="index" class="navbar-brand topnav pull-left">AnalyzeMe</a>
                <a href="action" type="button" class="btn btn-primary navbar-btn"><i class="glyphicon glyphicon-log-in"></i>   Try now</a>
